...
bool Renderer::Initialize(const float screen_width, const float screen_height)
{
	...
	m_shaders["floor"] = LoadShaders("Shaders/FloorLight.vert", "Shaders/FloorLight.frag");
	m_shaders["light"] = LoadShaders("Shaders/Light.vert", "Shaders/Light.frag");
	...
	m_texture = unique_ptr<Texture>(new Texture("Textures/Rock.jpg"));
...
void Renderer::DrawModels()
{
	...
	m_shaders["floor"]->SetVec3("lightPos", vec3(0.0f, 0.0f, 0.0f));
